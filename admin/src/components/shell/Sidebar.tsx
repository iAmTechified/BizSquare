...
export type AdminRoute = 'overview' | 'users' | 'setup_codes' | 'spotlight' | 'contacts' | 'notifications' | 'system' | 'audit' | 'taxonomy';
...
export const NAVIGATION_GROUPS: NavGroupConfig[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'spotlight', label: 'Spotlight', icon: 'spotlight', route: 'spotlight', enabled: true, requiredPermission: 'spotlight.view' },
      { id: 'contacts', label: 'Contacts & Gain', icon: 'contacts', route: 'contacts', enabled: true, requiredPermission: 'contacts.view' },
  ...
  },
  {
    label: 'CONTENT',
    items: [
      { id: 'taxonomy', label: 'Taxonomy', icon: 'interests', route: 'taxonomy', enabled: true, requiredPermission: 'system.view' },
