    ...
    switch (type) {
      case AppLaunchPromptType.contactsPermission:
        return _PromptConfig(
          badge: 'COMMUNITY SETUP · STEP 1 OF 3',
          headline: 'Sync Contacts to Gain Matches',
          subtitle: 'BizSquare matches your business with high-value clients across 100+ verified peer communities.',
      ...
      case AppLaunchPromptType.spotlightWidget:
        return _PromptConfig(
          ...
          subtitle: 'Stay ahead of your campaign turns and watch community participation escalate in real-time.',
